...
console.log(
  `Concatenating is easy when using template literals, I can even embed and not have to worry about spacing!`
);
//console log the three strings above and add a third string that includes the add var
console.log(
  `Concatenating is easy when using template literals, I can even embed and not have to worry about spacing! ${add}`
);
